...
/*   Updated: 2023/02/02 20:25:05 by sgomez-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct t_chunk_order
{
	int nbr;
	int pos;
} t_chunk_order;
typedef struct t_stack_chunk_values
{
	int min;
	int max;
	int first;
...
void quicksort(t_stack **stack_a, t_stack **stack_b, int low,
			   int high);
int partition(t_stack **stack_a, t_stack **stack_b, int low,
			  int high);
...
void	stack_b_nextchunk(t_stack **stack_a, t_stack **stack_b, t_chunk *chunk);
#endif